...
> Inspired by [awesome-tor](https://github.com/ajvb/awesome-tor) ⭐ 505 | 🐛 3 | 📅 2023-09-03 and [awesome-cpp](https://github.com/fffaraz/awesome-cpp) ⭐ 72,857 | 🐛 312 | 📅 2026-08-19 and other [Awesome Lists](https://github.com/topics/awesome).
>
...
* [I2P](https://github.com/i2p/i2p.i2p) ⭐ 2,683 | 🐛 17 | 🌐 Java | 📅 2026-08-21 - The first implementation. Written in Java. Android release of the I2P router: [Google Play](https://play.google.com/store/apps/details?id=net.i2p.android), [F-Droid](https://f-droid.org/packages/net.i2p.android.router/).
