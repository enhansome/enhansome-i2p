...
> Inspired by [awesome-tor](https://github.com/ajvb/awesome-tor) ⭐ 508 | 🐛 3 | 📅 2023-09-03 and [awesome-cpp](https://github.com/fffaraz/awesome-cpp) ⭐ 72,983 | 🐛 312 | 📅 2026-08-22 and other [Awesome Lists](https://github.com/topics/awesome).
>
...
* [I2Pd](https://github.com/PurpleI2P/i2pd) ⭐ 4,179 | 🐛 163 | 🌐 C++ | 📅 2026-08-29 - A C++ implementation of a I2P router. Android release of the I2Pd router: [F-Droid](https://f-droid.org/packages/org.purplei2p.i2pd/).
...
* [bitcoin](https://github.com/bitcoin/bitcoin) ⭐ 90,032 | 🐛 715 | 🌐 C++ | 📅 2026-08-28 - Bitcoin Core. More info [here](https://github.com/bitcoin/bitcoin/blob/master/doc/i2p.md) ⭐ 90,032 | 🐛 715 | 🌐 C++ | 📅 2026-08-28.
...
* [libtorrent-rasterbar](https://github.com/arvidn/libtorrent) ⭐ 6,044 | 🐛 254 | 🌐 C++ | 📅 2026-08-28 - libtorrent is a popular C++ BitTorrent library that has support for I2P.
