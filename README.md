...
> Inspired by [awesome-tor](https://github.com/ajvb/awesome-tor) ⭐ 509 | 🐛 0 | 📅 2026-09-23 and [awesome-cpp](https://github.com/fffaraz/awesome-cpp) ⭐ 73,459 | 🐛 311 | 📅 2026-09-20 and other [Awesome Lists](https://github.com/topics/awesome).
>
...
* [I2P](https://github.com/i2p/i2p.i2p) ⭐ 2,709 | 🐛 17 | 🌐 Java | 📅 2026-09-25 - The first implementation. Written in Java. Android release of the I2P router: [Google Play](https://play.google.com/store/apps/details?id=net.i2p.android), [F-Droid](https://f-droid.org/packages/net.i2p.android.router/).
* [I2P+](https://gitlab.com/i2pplus/I2P.Plus/) - I2P+ is a soft-fork of the Java I2P Anonymizing Network Layer.

### I2Pd

* [I2Pd](https://github.com/PurpleI2P/i2pd) ⭐ 4,207 | 🐛 163 | 🌐 C++ | 📅 2026-09-25 - A C++ implementation of a I2P router. Android release of the I2Pd router: [F-Droid](https://f-droid.org/packages/org.purplei2p.i2pd/).
* [Kovri](https://gitlab.com/kovri-project/kovri) - The Kovri I2P Router Project, a fork of I2Pd by the Monero project.

### Unfinished

* [ire](https://github.com/str4d/ire) ⭐ 160 | 🐛 19 | 🌐 Rust | 📅 2023-02-04 - I2P router implementation in Rust.
...
* [anonym8](https://github.com/HiroshiManRise/anonym8) ⭐ 322 | 🐛 21 | 🌐 Shell | 📅 2022-09-26 - Sets Transparent proxy tunnel through Tor, I2P, Privoxy, Polipo and modify DNS; Include Anonymizing Relay Monitor (arm), macchanger and wipe (Cleans ram/cache & swap-space) features, ID spoofing has never been so easy.
...
* [bitcoin](https://github.com/bitcoin/bitcoin) ⭐ 90,249 | 🐛 722 | 🌐 C++ | 📅 2026-09-25 - Bitcoin Core. More info [here](https://github.com/bitcoin/bitcoin/blob/master/doc/i2p.md) ⭐ 90,249 | 🐛 722 | 🌐 C++ | 📅 2026-09-25.
* [monero](https://github.com/monero-project/monero) ⭐ 10,873 | 🐛 611 | 🌐 C++ | 📅 2026-09-24 - Monero: the secure, private, untraceable cryptocurrency. It is open-source and accessible to all. With Monero, you are your own bank. Only you control and are responsible for your funds. Your accounts and transactions are kept private from prying eyes.
...
* [i2pd-tools](https://github.com/PurpleI2P/i2pd-tools) ⭐ 163 | 🐛 10 | 🌐 C++ | 📅 2026-09-23 - Some useful tools for I2P.
...
* [XD](https://github.com/majestrate/XD) ⭐ 276 | 🐛 29 | 🌐 Go | 📅 2026-08-30 - BitTorrent Client written in Go.
* [Transmission-I2P](https://github.com/l-n-s/transmission-i2p) ⭐ 43 | 🐛 1 | 🌐 C | 📅 2018-01-06 - Anonymous torrent client Transmission-I2P.
...
* [i2pdbrowser](https://github.com/PurpleI2P/i2pdbrowser) ⭐ 803 | 🐛 15 | 🌐 HTML | 📅 2025-03-08 - I2Pd browser bundle.
...
* [libtorrent-rasterbar](https://github.com/arvidn/libtorrent) ⭐ 6,073 | 🐛 252 | 🌐 C++ | 📅 2026-09-25 - libtorrent is a popular C++ BitTorrent library that has support for I2P.
* [i2p-rs](https://github.com/i2p/i2p-rs) ⭐ 105 | 🐛 6 | 🌐 Rust | 📅 2025-07-17 - Rust client library for interacting with I2P.
...
* [goSam](https://github.com/cryptix/goSam) ⭐ 40 | 🐛 2 | 🌐 Go | 📅 2019-12-23 - A Go library for using the I2P Simple Anonymous Messaging (SAM version 3.0) bridge.
* [libsam3](https://github.com/i2p/libsam3) ⭐ 38 | 🐛 10 | 🌐 C | 📅 2026-01-14 - C SAMv3 library.
* [i2p.rb](https://github.com/dryruby/i2p.rb) ⚠️ Archived - I2P.rb is a Ruby library for interacting with the I2P anonymity network. SAM and BOB.
* [i2p-sam](https://github.com/diva-exchange/i2p-sam) ⭐ 20 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-24 - TypeScript. I2P SAM: peer-to-peer communication between applications over I2P.
...
Thanks to all [contributors](https://github.com/mikalv/awesome-i2p/graphs/contributors) ⭐ 291 | 🐛 2 | 📅 2025-08-30!
