...
> Inspired by [awesome-tor](https://github.com/ajvb/awesome-tor) ⭐ 509 | 🐛 3 | 📅 2023-09-03 and [awesome-cpp](https://github.com/fffaraz/awesome-cpp) ⭐ 73,018 | 🐛 311 | 📅 2026-08-22 and other [Awesome Lists](https://github.com/topics/awesome).
>
...
* [I2P](https://github.com/i2p/i2p.i2p) ⭐ 2,687 | 🐛 16 | 🌐 Java | 📅 2026-08-30 - The first implementation. Written in Java. Android release of the I2P router: [Google Play](https://play.google.com/store/apps/details?id=net.i2p.android), [F-Droid](https://f-droid.org/packages/net.i2p.android.router/).
* [I2P+](https://gitlab.com/i2pplus/I2P.Plus/) - I2P+ is a soft-fork of the Java I2P Anonymizing Network Layer.

### I2Pd

* [I2Pd](https://github.com/PurpleI2P/i2pd) ⭐ 4,182 | 🐛 162 | 🌐 C++ | 📅 2026-08-30 - A C++ implementation of a I2P router. Android release of the I2Pd router: [F-Droid](https://f-droid.org/packages/org.purplei2p.i2pd/).
...
* [libtorrent-rasterbar](https://github.com/arvidn/libtorrent) ⭐ 6,045 | 🐛 251 | 🌐 C++ | 📅 2026-08-30 - libtorrent is a popular C++ BitTorrent library that has support for I2P.
