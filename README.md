...
> Inspired by [awesome-tor](https://github.com/ajvb/awesome-tor) ⭐ 510 | 🐛 3 | 📅 2023-09-03 and [awesome-cpp](https://github.com/fffaraz/awesome-cpp) ⭐ 73,150 | 🐛 310 | 📅 2026-09-05 and other [Awesome Lists](https://github.com/topics/awesome).
>
...
* [I2P](https://github.com/i2p/i2p.i2p) ⭐ 2,692 | 🐛 16 | 🌐 Java | 📅 2026-09-05 - The first implementation. Written in Java. Android release of the I2P router: [Google Play](https://play.google.com/store/apps/details?id=net.i2p.android), [F-Droid](https://f-droid.org/packages/net.i2p.android.router/).
* [I2P+](https://gitlab.com/i2pplus/I2P.Plus/) - I2P+ is a soft-fork of the Java I2P Anonymizing Network Layer.

### I2Pd

* [I2Pd](https://github.com/PurpleI2P/i2pd) ⭐ 4,191 | 🐛 163 | 🌐 C++ | 📅 2026-09-06 - A C++ implementation of a I2P router. Android release of the I2Pd router: [F-Droid](https://f-droid.org/packages/org.purplei2p.i2pd/).
...
* [libtorrent-rasterbar](https://github.com/arvidn/libtorrent) ⭐ 6,051 | 🐛 251 | 🌐 C++ | 📅 2026-09-05 - libtorrent is a popular C++ BitTorrent library that has support for I2P.
